...
public class Alert extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.cbx.model.avro.alert_status status;
   ...
   */
  public Alert(java.lang.Long sensor_id, java.lang.Long time, com.cbx.model.avro.alert_status status) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: status = (com.cbx.model.avro.alert_status)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.cbx.model.avro.alert_status getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(com.cbx.model.avro.alert_status value) {
    this.status = value;
  }
   ...
   */
  public static com.cbx.model.avro.Alert.Builder newBuilder() {
    return new com.cbx.model.avro.Alert.Builder();
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static com.cbx.model.avro.Alert.Builder newBuilder(com.cbx.model.avro.Alert.Builder other) {
    return new com.cbx.model.avro.Alert.Builder(other);
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static com.cbx.model.avro.Alert.Builder newBuilder(com.cbx.model.avro.Alert other) {
    return new com.cbx.model.avro.Alert.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Alert>
    ...
    private long time;
    /** The allowed values that our sensors will use to emit current status */
    private com.cbx.model.avro.alert_status status;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.cbx.model.avro.Alert.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.cbx.model.avro.Alert other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.sensor_id)) {
        this.sensor_id = data().deepCopy(fields()[0].schema(), other.sensor_id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cbx.model.avro.Alert.Builder setSensorId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cbx.model.avro.Alert.Builder clearSensorId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cbx.model.avro.Alert.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cbx.model.avro.Alert.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cbx.model.avro.Alert.Builder setStatus(com.cbx.model.avro.alert_status value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cbx.model.avro.Alert.Builder clearStatus() {
      status = null;
    ...
    public Alert build() {
      try {
        ...
        record.status = fieldSetFlags()[2] ? this.status : (com.cbx.model.avro.alert_status) defaultValue(fields()[2]);
        return record;
